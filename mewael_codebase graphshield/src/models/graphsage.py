...
class GraphSAGE(nn.Module):
    ...
    def __init__(
        ...
        # Three conv layers (reduced from 4 — fewer layers, better generalisation)
        ...
        # Input projection for first residual (in → hidden, no bias)
    ...
    def forward(self, x, edge_index):
        ...
        h = h + self.input_proj(x)          # residual: projected raw features
